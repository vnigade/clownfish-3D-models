...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default='',
        type=str,
        help='Save data (.pth) of previous siminet training')
    parser.add_argument(
    ...
    parser.add_argument('--modality', default='RGB', type=str,
                        help='Modality of input data. RGB, Flow or RGBFlow')
    parser.add_argument('--downsample', default=1, type=int,
                        help='Downsampling. Selecting 1 frame out of N')
    parser.add_argument('--lr_steps', default=[40, 55, 65, 70, 200, 250], type=float,
                        nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
